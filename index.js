...
const getServers = async (id) => {
  const resp = await (
    await fetch(
      `	https://animekai.to/ajax/links/list?token=${id}&_=${decoder.GenerateToken(
        id
      )}`,
      {
        headers: {
...
function v(n) {
  return n = i(c(i(e("QKbVomcBHysCW9", f(c(f(i(e("PgiY5eIZWn", i(e("3U8XtHJfgam02k", c(f(n = encodeURIComponent(n), "IM7Am4D2yYHctL", "7DtY4mHcMA2yIL")))))), "rXEsS3nbjhUd", "rXjnhU3SsbEd")), "Go1UiY82st0Oa", "0GsO8otUi21aY")))));
}
function x(n) {
  n = f(c(e("3U8XtHJfgam02k", o(e("PgiY5eIZWn", o(f(c(f(e("QKbVomcBHysCW9", o(c(o(n = `${n}`)))), "0GsO8otUi21aY", "Go1UiY82st0Oa")), "rXjnhU3SsbEd", "rXEsS3nbjhUd")))))), "7DtY4mHcMA2yIL", "IM7Am4D2yYHctL");
