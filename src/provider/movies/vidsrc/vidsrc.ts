...
export async function _getMovieHash(tmdbId: number, server: VidSRCServers) {
  try {
...
export async function _getTvHash(tmdbId: number, season: number, episodeNumber: number, server: VidSRCServers) {
  try {
