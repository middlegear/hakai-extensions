...
// const data = await _getsources('movie/episodes/109831', 'akcloud');
// const data = await _getsources('episode/servers/1019968', 'akcloud');
...
// const data = await hianime.fetchSources('solo-leveling-18718-episode-119497', HiAnimeServers.HD3, SubOrDub.DUB);
