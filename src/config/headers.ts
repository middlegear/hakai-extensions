...
export const ACCEPT_ENCODING = "gzip, deflate, br, zstd" as const;

//// anitaku  headers config
...
////animez headers config
export const animeZ_USER_AGENT_HEADER =
  "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:132.0) Gecko/20100101 Firefox/132.0" as const;
